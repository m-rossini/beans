...
def test_world_initialize_counts_by_density():
    cfg = WorldConfig(male_sprite_color='blue', female_sprite_color='red', male_female_ratio=1.0, sprite_bean_size=10, width=20, height=20, population_density=1.0, placement_strategy='random')

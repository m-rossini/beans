...
def test_world_window_uses_config_dimensions(monkeypatch):
    cfg = WorldConfig(male_sprite_color='blue', female_sprite_color='red', male_female_ratio=1.0, sprite_bean_size=10, width=200, height=150, population_density=1.0, placement_strategy='random')
